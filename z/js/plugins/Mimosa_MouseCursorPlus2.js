/*:============================================================================
  ...
  @plugindesc | Mimosa Mouse Cursor : Version - 1.4.4 | This plugin allows you to change the cursor of your mouse while in the game window!.
...
//=============================================================================
      ...
      const baseX = x * zoom.x - baseW * anchor.x;
      const baseY = y * zoom.y - baseH * anchor.y;
...
//=============================================================================
    ...
    dx = Math.floor( dx / sprite.scale.x / zoom.x );
    dy = Math.floor( dy / sprite.scale.y / zoom.y );
...
//=============================================================================
    ...
    if(!clickBitmap) return undefined;
