...
function window_set_size(_w,_h) 
{
    ...
    if(window.nw){
        //https://learn.microsoft.com/en-us/windows/iot-core/develop-your-app/signindialogtitlebars
        //nw.Window.get().width = _w + 25;
        //nw.Window.get().height = _h;
        nw.Window.get().resizeTo(_w,_h)
    }
}
